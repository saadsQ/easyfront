...
import { CreateInventoryRequest, UnitOfMeasure, InventoryStatus } from '../../types/inventory';
...
interface AddInventoryModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (item: CreateInventoryRequest) => void;
  suppliers: Supplier[];
}
...
export const AddInventoryModal: React.FC<AddInventoryModalProps> = ({
  ...
  const [errors, setErrors] = useState<Partial<CreateInventoryRequest>>({});
  ...
  const validateForm = (): boolean => {
    const newErrors: Partial<CreateInventoryRequest> = {};
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Enter part information and stock details</p>
              </div>
            </div>
            <Button
              variant="ghost"
